...
class Equipment extends CI_Controller {
	...
	{
		$jumlah= $this->Crud_m->view_where('equipment',array('equipment_status'=>'publish'))->num_rows();
		$config['base_url'] = base_url().'equipment/index/page/';
		...
		if (is_numeric($dari)) {
			...
			$data['posts'] = $this->Crud_m->view_where_orderings('equipment',array('equipment_status'=>'publish'),'equipment_id','DESC');
		...
		$this->load->view('frontend/v_equipment',$data);
	}
}
